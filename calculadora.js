...
const ttonoff = document.querySelector(".tonoff")
const tlimpar = document.querySelector("#tlimpar")
const ttseparador = document.querySelector("#tseparador")
...
calc_aba.addEventListener("click", (evt)=>{
    ...
    if(calc.classList.contains("calc_exibir")){
        img_aba_calc.setAttribute("src", "setaesquerda.png")
    }else{
        img_aba_calc.setAttribute("src", "./setadireita.png")
    }
})